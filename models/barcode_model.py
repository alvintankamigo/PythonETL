...
class BarcodeModel:
    def __init__(self, code=None, name=None, spec=None, trademark=None, addr=None,
                 ...
                 updateAt=None, wholeunit=None, wholenum=None, img=None, src=None):
        self.code = code
    ...
    def generate_insert_sql(self):
        sql = f"replace into {config.target_barcode_table_name}(code,name,spec,trademark,addr,units,factory_name," \
              f"trade_price,retail_price,updateAt,wholeunit,wholenum,img,src) values (" \
              f"'{self.code}'," \
