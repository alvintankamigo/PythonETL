...
output_path = "/Users/tandunqian/PythonEtl/source_database_logging/"  # 此目录必须提前创建，否则会导致无法生成日志到指定目录
...
visitor_areas = {
    ...
    '湖南省': ['长沙市', '长沙市', '长沙市', '长沙市', '长沙市', '长沙市', '长沙市', '株洲市', '张家界市', '常德市',
               '益阳市'],
    '浙江省': ['杭州市', '杭州市', '湖州市', '绍兴市', '舟山市', '金华市', '嘉兴市', '丽水市']
}
visitor_province = ['北京市', '上海市', '重庆市', '江苏省', '安徽省', '山东省', '湖北省', '广东省', '天津市', '湖南省',
                    '浙江省']
